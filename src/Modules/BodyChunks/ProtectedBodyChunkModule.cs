/*
namespace MRCustom.Modules.BodyChunks;

public class ProtectedBodyChunkModule
{
    public PhysicalObjectModule ownerModule;
    public int protectingBodyChunkIndex = 0;

    public ProtectedBodyChunkModule(PhysicalObjectModule ownerModule, int protectingBodyChunkIndex)
    {
        this.ownerModule = ownerModule;
        this.protectingBodyChunkIndex = protectingBodyChunkIndex;
    }

    public virtual void DeflectSpear(Spear spear)
    {
        // Spear bounces off.
        spear.vibrate = 20;
    ...
    public virtual bool PreSpearHitWearer(Spear spear, SharedPhysics.CollisionResult result, bool eu)
    {
        ...
        if (ownerModule.owner.TryGetPhysicalObjectModule<HealthModule>(out var healthModule))
        {
