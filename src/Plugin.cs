...
sealed class Plugin : BaseUnityPlugin
{
    ...
    private void RegisterObjectIconSymbolProperties()
    {
        ...
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.KarmaFlower, new ObjectIconSymbolProperties("KarmaFlower", "smallKarma9-9", Custom.hexToColor("bba557"), 0.5f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.SlimeMold, new ObjectIconSymbolProperties("SlimeMold", "Symbol_SlimeMold", Custom.hexToColor("ff9900"), 1f));
        ...
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.FirecrackerPlant, new ObjectIconSymbolProperties("FirecrackerPlant", "Symbol_Firecracker", new Color(0.68235296f, 0.15686275f, 0.11764706f), 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.ScavengerBomb, new ObjectIconSymbolProperties("ScavengerBomb", "Symbol_StunBomb", new Color(0.9019608f, 0.05490196f, 0.05490196f), 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.FlareBomb, new ObjectIconSymbolProperties("FlareBomb", "Symbol_FlashBomb", Custom.hexToColor("b4a8f6"), 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.SporePlant, new ObjectIconSymbolProperties("SporePlant", "Symbol_SporePlant", new Color(0.68235296f, 0.15686275f, 0.11764706f), 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.PuffBall, new ObjectIconSymbolProperties("PuffBall", "Symbol_PuffBall", Color.grey, 1f));
        ...
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.DataPearl, new ObjectIconSymbolProperties("DataPearl", "Symbol_Pearl", Color.grey, 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.VultureMask, new ObjectIconSymbolProperties("VultureMask", "Kill_Vulture", Color.grey, 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.NeedleEgg, new ObjectIconSymbolProperties("NeedleEgg", "needleEggSymbol", new Color(0.5764706f, 0.16078432f, 0.2509804f), 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.OverseerCarcass, new ObjectIconSymbolProperties("OverseerCarcass", "Kill_Overseer", Color.grey, 1f));
        ObjectIconSymbolPropertiesManager.AddObjectIconSymbolProperties(AbstractPhysicalObject.AbstractObjectType.DangleFruit, new ObjectIconSymbolProperties("DangleFruit", "smallKarmaNoRing3", new Color(0f, 1f, 0f), 0.85f));
